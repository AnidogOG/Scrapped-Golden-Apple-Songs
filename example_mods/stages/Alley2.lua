function onCreate()
	...
	makeAnimatedLuaSprite('unhinged_dumpsta', 'backgrounds/extras/unhinged/dumpster', -650, 960)
	addAnimationByPrefix('unhinged_dumpsta', 'unhinged_dumpsta', 'idle', 24, true);
	addLuaSprite('unhinged_dumpsta',false)
	scaleObject('hi', 0.6, 0.6)
	
	makeLuaSprite('hat','backgrounds/extras/unhinged/hat', -2800, 120)
