...
enum MenuSongsColumn {
	CENTER;
}

class MenuSongsState extends MusicBeatState
{
	public static var psychEngineVersion:String = '2.0'; // This is also used for Discord RPC
	public static var curSelected:Int = 0;
	public static var curColumn:MenuSongsColumn = CENTER;
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT || (FlxG.mouse.justPressed && allowMouse))
			{
				...
				FlxFlicker.flicker(item, 1, 0.06, false, false, function(flick:FlxFlicker)
				{
					...
					{
						case 'jambino v1':
							PlayState.SONG = backend.Song.loadFromJson('jambino-v1', 'jambino-v1');
							LoadingState.loadAndSwitchState(new PlayState());
						case 'jambino v2':
							PlayState.SONG = backend.Song.loadFromJson('jambino-v2', 'jambino-v2');
							LoadingState.loadAndSwitchState(new PlayState());
						case 'jambino v3':
							PlayState.SONG = backend.Song.loadFromJson('jambino-v3', 'jambino-v3');
							LoadingState.loadAndSwitchState(new PlayState());
						case 'kirbathon':
							PlayState.SONG = backend.Song.loadFromJson('kirbathon', 'kirbathon');
							LoadingState.loadAndSwitchState(new PlayState());
						case 'extras':
	...
	function updateDiffies() 
	{
		...
		difficultyImg.loadGraphic(Paths.image('diff/' + backend.CoolUtil.songDiffRating(optionShit[curSelected].toLowerCase())));
		difficultyImg.scale.set(0.5, 0.5);
		difficultyImg.setPosition(FlxG.width - ((546 / 1.4) + 10), FlxG.height - ((497 / 1.4) + 10));
